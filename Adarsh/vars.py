...
class Var(object):
    ...
    SHORTLINK_URL = getenv('SHORTLINK_URL', 'moneycase.link')
    SHORTLINK_API = getenv('SHORTLINK_API', '95fc96273f2174408c7126b8b55619171e12bfd8')
    TUTORIAL_URL = getenv('TUTORIAL_URL', 'https://t.me/+C7-_1fuc7zViOTk1')    
